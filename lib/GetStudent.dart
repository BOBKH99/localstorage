...
class _GetstudentState extends State<Getstudent> {
  ...
  void initState() {
    ...
    id = widget.id;
    fetchStudent();
    _nameController = TextEditingController(text: student[0]['name']);
    _ageController = TextEditingController(text: student[0]['age'].toString());
    _scoreController = TextEditingController(text: student[0]['score'].toString());
    _classController = TextEditingController(text: student[0]['studentClass']);
    _birthdayController = TextEditingController(text: student[0]['birthday'].toIso8601String().substring(0, 10));
    _phoneController = TextEditingController(text: student[0]['phone'].toString());
    _imagePath = student[0]['imagePath'].imagePath;
    _initializeData();
  }
  ...
  Future<void> fetchStudent()async {
    final students = await _dbHelper.fetchStudent(id);
    setState(() {
      student = students;
    });
  }
